! function (e, t) {
    ...
    return function (e) {
        ...
        let a = {
            ...
            labels: {
        	   menuTitle: ((lang == 0) ? "Pristupačnost" : "Accessibility"),
               increaseText: ((lang == 0) ? "Povećaj veličinu fonta" : "Increase font size"),
               resetText: ((lang == 0) ? "Poništi veličinu fonta" : "Reset font size"),
               highContrast: ((lang == 0) ? "Kontrast (crna pozadina)" : "Contrast (black background)"),
               highContrastWhite: ((lang == 0) ? "Kontrast (bijela pozadina)" : "Contrast (white background)"),
               dyslexicFont: ((lang == 0) ? "Disleksija" : "Dyslexia"),
               underlineLinks: ((lang == 0) ? "Podcrtaj linkove" : "Underline links"),
        ...
        class r {
            constructor(e = {}) {
                ...
                let t = null,
                    ...
                    w = null,
                    i = null;
                null == (t = window.sessionStorage.getItem("_access-increasetext")) && (t = window.localStorage.getItem("_access-increasetext")), null == (n = window.sessionStorage.getItem("_access-dyslexicfont")) && (n = window.localStorage.getItem("_access-dyslexicfont")), null == (s = window.sessionStorage.getItem("_access-highcontrast")) && (s = window.localStorage.getItem("_access-highcontrast")), null == (i = window.sessionStorage.getItem("_access-underlinelinks")) && (i = window.localStorage.getItem("_access-underlinelinks")), "true" === t && this.menuInterface.increaseText(), "true" === n && this.menuInterface.dyslexicFont(), "black" === s && this.menuInterface.highContrast(), "white" === s && this.menuInterface.highContrastWhite(), "true" === i && this.menuInterface.underlineLinks(), "true" === window.sessionStorage.getItem("_access-settings-changed") && (document.querySelector("._access-menu p button").removeAttribute("disabled"), window.sessionStorage.removeItem("_access-settings-changed"))
            }
                ...
                let e = c.jsonToHtml({
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            type: "li",
                            attrs: {
                                "data-access-action": "highContrastWhite"
                            },
                            children: [{
                                type: "#text",
                                text: this.options.labels.highContrastWhite
                            }]
                        }, {
                            type: "li",
                            attrs: {
                        ...
                        children: [{
                            type: "#text",
                            text: ((lang == 0) ? "Ako želite spremiti trajne postavke, kliknite Spremi, ako ne - vaše će se postavke poništiti kad zatvorite preglednik." : "If you want to save the settings permanently, click Save, if not - your settings will be reset when you close your browser.")
                        }, {
                            type: "button",
                            attrs: {
            ...
            build() {
                ...
                this.menuInterface = {
                    ...
                    highContrast: () => {
                        ...
                        e ? (this.html.removeAttribute("data-highcontrast-applied"), window.sessionStorage.setItem("_access-highcontrast", "false"), window.location.reload()) : (this.html.removeAttribute("data-highcontrastwhite-applied"), c.addInlineStyle(document.body, n + ";;background-color:#000!important;;"), [].forEach.call(t, e => {
                        ...
                        }), this.html.setAttribute("data-highcontrast-applied", "true"), window.sessionStorage.setItem("_access-highcontrast", "black")), document.querySelector("._access-menu p button").removeAttribute("disabled"), window.sessionStorage.setItem("_access-settings-changed", "true")
                    },
                    highContrastWhite: () => {
                        let e = this.html.getAttribute("data-highcontrastwhite-applied"),
                            t = document.querySelectorAll("*");
                        const n = ";;color:#000!important;opacity:1!important;;";
                        e ? (this.html.removeAttribute("data-highcontrastwhite-applied"), window.sessionStorage.setItem("_access-highcontrast", "false"), window.location.reload()) : (this.html.removeAttribute("data-highcontrast-applied"), c.addInlineStyle(document.body, n + ";;background-color:#fff!important;;"), [].forEach.call(t, e => {
                        	 "none" !== getComputedStyle(e).backgroundImage || "IMG" === e.tagName || e.classList.contains("circle", "slice") || e.classList.contains("slice") || e.classList.contains("bar") ||  e.classList.contains("narancasta") || e.classList.contains("crvena") || e.classList.contains("progress") || e.classList.contains("focus-input100") || e.classList.contains("lnr-user") || e.classList.contains("lnr-lock") || e.classList.contains("navigation-trigger__line") || e.classList.contains("symbol-input100") || e.classList.contains("jjambg") || e.classList.contains("wrap-input100") || e.classList.contains("progress-bar") || c.addInlineStyle(e, ";;background-color:#fff!important;;"), c.addInlineStyle(e, n)
                        }), this.html.setAttribute("data-highcontrastwhite-applied", "true"), window.sessionStorage.setItem("_access-highcontrast", "white")), document.querySelector("._access-menu p button").removeAttribute("disabled"), window.sessionStorage.setItem("_access-settings-changed", "true")
                    },
                    dyslexicFont: () => {
                    ...
                    saveSettings: () => {
                        "true" === window.sessionStorage.getItem("_access-increasetext") ? window.localStorage.setItem("_access-increasetext", "true") : window.localStorage.removeItem("_access-increasetext"), "black" === window.sessionStorage.getItem("_access-highcontrast") ? window.localStorage.setItem("_access-highcontrast", "black") : ("white" === window.sessionStorage.getItem("_access-highcontrast") ? window.localStorage.setItem("_access-highcontrast", "white") : window.localStorage.removeItem("_access-highcontrast")), "true" === window.sessionStorage.getItem("_access-dyslexicfont") ? window.localStorage.setItem("_access-dyslexicfont", "true") : window.localStorage.removeItem("_access-dyslexicfont"), "true" === window.sessionStorage.getItem("_access-underlinelinks") ? window.localStorage.setItem("_access-underlinelinks", "true") : window.localStorage.removeItem("_access-underlinelinks"), document.querySelector("._access-menu p button").setAttribute("disabled", "disabled"), this.toggleMenu()
                    }
                }
            }
